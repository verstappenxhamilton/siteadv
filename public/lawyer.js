...
(() => {
  ...
  let currentChatClientId = null;
    ...
    async function loadConfig() {
      try {
        ...
        if (configForm) {
          ...
          configForm.querySelector('textarea[name="prompt"]').value = data.prompt || defaultPrompt;
    ...
    loadConfig().then(() => updateProviderSettings({ skipModel: true }));
    loadKeys();
