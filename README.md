...
3. O Render usará o `render.yaml` para rodar `npm install && npm run build` e iniciar com `npm start`.
4. (Opcional) O `Dockerfile` pode ser usado para construir a imagem manualmente.
5. Defina as variáveis de ambiente no painel do Render.
