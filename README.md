...
3. O Render lerá o `render.yaml` e executará `npm install`, `npm run build` e `npm run start`.
4. (Opcional) O `Dockerfile` está disponível caso queira gerar a imagem manualmente.
