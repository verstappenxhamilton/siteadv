          ...
          <div>
            ...
            <div className="space-y-4 text-lg">
              <div className="flex items-center space-x-4">
                  ...
                  <a href="tel:+43574301234" className="tracking-wider hover:text-[#B98F58] transition-colors">43 57430 1234</a>
              </div>
              <div className="flex items-center space-x-4">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-[#B98F58]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
                  <a href="mailto:contato@pavan.adv.br" className="hover:text-[#B98F58] transition-colors">contato@pavan.adv.br</a>
              </div>
            </div>
          </div>
          <div>
