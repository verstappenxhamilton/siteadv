...
export const SocialIconsList: React.FC = () => (
    <div className="social-icons-container">
        <SocialIcon href="https://wa.me/1234567890" aria-label="Whatsapp"><WhatsappIcon className="social-icon" /></SocialIcon>
        <SocialIcon href="https://twitter.com/pavan" aria-label="Twitter"><TwitterIcon className="social-icon" /></SocialIcon>
        <SocialIcon href="https://instagram.com/pavan" aria-label="Instagram"><InstagramIcon className="social-icon" /></SocialIcon>
    </div>
);