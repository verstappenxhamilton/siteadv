      ...
      <div className="flex flex-col md:flex-row items-center gap-12">
        ...
        <div className="md:w-2/3 md:pl-10">
          ...
          <p className="text-gray-600 mb-4 text-lg leading-relaxed">
            Com mais de 15 anos de experiência e uma paixão incansável pela justiça, Dr. Ricardo Pavan fundou a Pavan &amp;
            Associados com a missão de oferecer uma advocacia acessível, transparente e altamente eficaz.
          </p>
          <p className="text-gray-600 mb-6 leading-relaxed">
            Especializado em direito imobiliário e sucessório, ele lidera uma equipe dedicada a proteger os interesses e o
            patrimônio de seus clientes, transformando complexidades legais em soluções claras e seguras. Sua abordagem combina
            rigor técnico com um profundo entendimento das necessidades humanas por trás de cada caso.
          </p>
          <a
            href="#contact"
