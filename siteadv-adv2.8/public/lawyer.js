...
(() => {
  ...
  const incomingModal = (typeof window !== 'undefined' && window.bootstrap && typeof window.bootstrap.Modal === 'function' && incoming)
    ? new window.bootstrap.Modal(incoming, { backdrop: 'static', keyboard: false })
    : null;
